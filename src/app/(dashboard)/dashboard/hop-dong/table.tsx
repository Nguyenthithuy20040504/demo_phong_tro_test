...
const getKhachThueName = (khachThue: any, khachThueList: KhachThue[]) => {
  if (typeof khachThue === 'object' && khachThue !== null) {
    return khachThue.hoTen || khachThue.ten || khachThue.name || 'N/A';
  }
