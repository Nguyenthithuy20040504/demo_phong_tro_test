      ...
      <Dialog open={isCreateAccountOpen} onOpenChange={setIsCreateAccountOpen}>
        <DialogContent className="w-[95vw] md:w-full max-w-md">
          ...
          <div className="space-y-4 py-2">
            ...
            {/* Email */}
            <div className="space-y-2">
              <Label htmlFor="acc-email" className={!!createAccountTarget?.email ? "text-gray-500" : ""}>Email nhận thông báo <span className="text-red-500">*</span></Label>
              <Input
                id="acc-email"
                type="email"
                ...
                className={`h-11 ${!!createAccountTarget?.email ? "bg-gray-100 border-gray-200 text-gray-600 focus-visible:ring-0" : ""}`}
              />
            </div>
