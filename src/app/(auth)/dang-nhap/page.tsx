            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex flex-col gap-4">
                <div className="text-center">
                  <Link href="/quen-mat-khau" className="text-xs text-muted-foreground/60 hover:text-primary transition-colors font-medium">
                    Quên mật khẩu?
                  </Link>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-3">
                  <Button
                    ...
                    className="flex-1 h-12 md:h-14 rounded-2xl border-muted/20 hover:bg-white dark:hover:bg-white/5 transition-all font-semibold flex gap-3 shadow-sm"
                  >
